...
/* ===== 发送/停止按钮:outer-cont 胶囊(仅匹配发送/停止,避免影响其他按钮) ===== */
body[data-input-skin="on"] [data-composer-card] button[aria-label="发送"],
body[data-input-skin="on"] [data-composer-card] button[aria-label="停止"],
body[data-input-skin="on"] [data-composer-card] button[aria-label="Send"],
body[data-input-skin="on"] [data-composer-card] button[aria-label="Stop"],
body[data-input-skin="on"] [data-composer-card] button:last-of-type{
  cursor:pointer;
  padding:12px 20px;
  border:none;
  font-size:1rem;
...
body[data-input-skin="on"] [data-composer-card] button[aria-label="发送"] svg,
body[data-input-skin="on"] [data-composer-card] button[aria-label="停止"] svg,
body[data-input-skin="on"] [data-composer-card] button[aria-label="Send"] svg,
body[data-input-skin="on"] [data-composer-card] button[aria-label="Stop"] svg,
body[data-input-skin="on"] [data-composer-card] button:last-of-type svg{display:none;}
body[data-input-skin="on"] [data-composer-card] button[aria-label="发送"]::before,
body[data-input-skin="on"] [data-composer-card] button[aria-label="停止"]::before,
body[data-input-skin="on"] [data-composer-card] button[aria-label="Send"]::before,
body[data-input-skin="on"] [data-composer-card] button[aria-label="Stop"]::before,
body[data-input-skin="on"] [data-composer-card] button:last-of-type::before{
  content:"";
...
body[data-input-skin="on"] [data-composer-card] button[aria-label="发送"]::after,
body[data-input-skin="on"] [data-composer-card] button[aria-label="停止"]::after,
body[data-input-skin="on"] [data-composer-card] button[aria-label="Send"]::after,
body[data-input-skin="on"] [data-composer-card] button[aria-label="Stop"]::after,
body[data-input-skin="on"] [data-composer-card] button:last-of-type::after{
