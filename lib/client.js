...
/* ===== 发送/停止按钮:outer-cont 胶囊 + 图标 + 文字(文字跟随按钮 aria-label) ===== */
body[data-input-skin="on"] [data-composer-card] button{
  cursor:pointer;
  padding:12px 20px;
  border:none;
  font-size:1rem;
...
body[data-input-skin="on"] [data-composer-card] button svg{display:none;}
body[data-input-skin="on"] [data-composer-card] button::before{
  content:"";
...
body[data-input-skin="on"] [data-composer-card] button::after{
